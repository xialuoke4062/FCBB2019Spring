...
setwd("/Users/danpeng/Desktop/FCBB2019Spring/UCEC/")
myTable = read.csv("encodedUCEC.csv") # change this to appropriate file name 
...
write.csv(bigSummaryDf, file = "bigSummaryDf_UCEC.csv")
save(distributionList, file = "distributionList_UCEC.rda")
