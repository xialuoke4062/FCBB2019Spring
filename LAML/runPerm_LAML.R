...
setwd("/Users/danpeng/Desktop/FCBB2019Spring/LAML/")
myTable = read.csv("encodedLAML.csv") # change this to appropriate file name 
...
write.csv(bigSummaryDf, file = "bigSummaryDf_LAML.csv")
save(distributionList, file = "distributionList_LAML.rda")
