saveFileName = "encodedLAML.csv"
myMaf = read.csv("/Users/danpeng/Dropbox (CahanLab)/Foundation_FinalProject/GDCdata/TCGA.LAML.muse.0cdf3c70-ad58-462d-b6ba-5004b26c618e.DR-10.0.somatic.maf.csv")
