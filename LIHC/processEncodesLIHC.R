saveFileName = "encodedLIHC.csv"
myMaf = read.csv("/Users/danpeng/Dropbox (CahanLab)/Foundation_FinalProject/GDCdata/TCGA.LIHC.muse.b9d7ec0e-afac-41ee-bd08-0acbfa0e3858.DR-10.0.somatic.maf.csv")
