saveFileName = "encodedKIRC.csv"
myMaf = read.csv("/Users/danpeng/Dropbox (CahanLab)/Foundation_FinalProject/GDCdata/GDCdata/TCGA.KIRC.muse.716f5244-9e13-4375-8c30-147bf9a02bb4.DR-10.0.somatic.maf.csv")
